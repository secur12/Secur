...
//        let goToEmailTap = UITapGestureRecognizer(target: self, action: #selector(switchToEmail()))
...
//        alreadyHaveSignIn.isUserInteractionEnabled = true
        ...
        self.signInButton.addTarget(self, action: #selector(switchToEmail), for: .touchUpInside)
...
//        }
        ...
        self.signInButton.snp.makeConstraints { (make) in
            make.bottom.equalToSuperview().offset(-60.withRatio())
    ...
    @objc func switchToEmail() {
        self.presenter.switchToMaster()
