//
//  PINSetupPresenter+SignUp.swift
//  SecurePlace2
//
...
class PINSetupSignUpPresenter: BasePresenter {
...
extension PINSetupSignUpPresenter: PINSetupPresenterProtocol {
    
    func didFinishEnteringCode(code: String) {
        self.wireFrame.presentPINConfirmSignUpViewController(from: self.view, accessToken: self.accessToken, refreshToken: self.refreshToken, pin: code)
    }
}
